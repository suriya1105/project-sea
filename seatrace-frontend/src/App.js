...
import { Menu, X, Zap, Activity, Globe, Anchor, Shield, Lock, User, CheckCircle, Trash2, FileText, AlertTriangle, Download, Clipboard, Loader, UserPlus, Users, BarChart2, ArrowRight } from 'lucide-react';
            ...
            {/* Reports Tab - Visual Dashboard */}
            {
              activeTab === 'reports' && (
                <div className="flex-1 overflow-y-auto p-6 bg-slate-900">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {/* Report Card 1 */}
                    <div className="cyber-panel bg-slate-800 border border-slate-700 overflow-hidden group hover:border-cyan-500/50 transition-all">
                      <div className="h-48 overflow-hidden relative">
                        <img
                          src="https://images.unsplash.com/photo-1621451537084-482c73073a0f?q=80&w=600"
                          alt="Report 1"
                          className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
                        />
                        <div className="absolute top-2 right-2 bg-red-500/80 backdrop-blur px-2 py-0.5 rounded text-xs font-bold text-white">
                          CRITICAL
                        </div>
                      </div>
                      <div className="p-4">
                        <div className="text-xs text-slate-400 mb-1">2 HOURS AGO • SECTOR 7</div>
                        <h3 className="text-lg font-bold text-white mb-2 group-hover:text-cyan-400 transition-colors">Illegal Discharge Detected</h3>
                        <p className="text-sm text-slate-300 mb-4 line-clamp-2">
                          Sentinel-1B identified a 4km oil slick trailing vessel IMO 9123456. High confidence spectral match.
                        </p>
                        <button className="w-full py-2 bg-slate-900 border border-slate-700 hover:bg-cyan-900/30 text-cyan-400 text-sm rounded flex items-center justify-center gap-2 transition-colors">
                    ...
                    <div className="cyber-panel bg-slate-800 border border-slate-700 overflow-hidden group hover:border-cyan-500/50 transition-all">
                      <div className="h-48 overflow-hidden relative">
                        <img
                          src="https://images.unsplash.com/photo-1542350719-7517c919d650?q=80&w=600"
                          alt="Report 2"
                          className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
                        />
                        <div className="absolute top-2 right-2 bg-green-500/80 backdrop-blur px-2 py-0.5 rounded text-xs font-bold text-white">
                          CLEARED
                        </div>
                      </div>
                      <div className="p-4">
                        <div className="text-xs text-slate-400 mb-1">1 DAY AGO • STRAIT OF MALACCA</div>
                        <h3 className="text-lg font-bold text-white mb-2 group-hover:text-cyan-400 transition-colors">Routine Patrol Summary</h3>
                        <p className="text-sm text-slate-300 mb-4 line-clamp-2">
                          Automated drone surveillance of shipping lanes shows 98% compliance with traffic separation schemes.
                        </p>
                        <button className="w-full py-2 bg-slate-900 border border-slate-700 hover:bg-cyan-900/30 text-cyan-400 text-sm rounded flex items-center justify-center gap-2 transition-colors">
                          VIEW FULL DOSSIER <ArrowRight className="w-3 h-3" />
                        </button>
                    ...
                    <div className="cyber-panel bg-slate-800 border border-slate-700 overflow-hidden group hover:border-cyan-500/50 transition-all">
                      <div className="h-48 overflow-hidden relative">
                        <img
                          src="https://images.unsplash.com/photo-1516685018646-549198525c1b?q=80&w=600"
                          alt="Report 3"
                          className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
                        />
                        <div className="absolute top-2 right-2 bg-blue-500/80 backdrop-blur px-2 py-0.5 rounded text-xs font-bold text-white">
                          ANALYSIS
                        </div>
                      </div>
                      <div className="p-4">
                        <div className="text-xs text-slate-400 mb-1">3 DAYS AGO • INDIAN OCEAN</div>
                        <h3 className="text-lg font-bold text-white mb-2 group-hover:text-cyan-400 transition-colors">Seasonal Currents Report</h3>
                        <p className="text-sm text-slate-300 mb-4 line-clamp-2">
                          Q4 Oceanographic assessment for spill forecasting models. Current velocities +15% above average.
                        </p>
                        <button className="w-full py-2 bg-slate-900 border border-slate-700 hover:bg-cyan-900/30 text-cyan-400 text-sm rounded flex items-center justify-center gap-2 transition-colors">
                          VIEW FULL DOSSIER <ArrowRight className="w-3 h-3" />
                        </button>
