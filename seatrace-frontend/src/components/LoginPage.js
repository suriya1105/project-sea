...
import { User, Lock, ArrowRight, Activity, Shield, Zap, Eye, EyeOff, Anchor, Wind, Navigation } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-slate-900">
            ...
            <div className="flex w-full max-w-6xl relative z-10 p-4 gap-16 lg:gap-24 items-center justify-center lg:justify-between flex-col lg:flex-row">
                ...
                {/* Left: Holographic Ship Visual */}
                <div className="hidden lg:flex flex-1 flex-col items-center justify-center relative group perspective-1000">
                ...
                <div className="w-full lg:w-[420px]">
                    <div className="bg-slate-900/60 backdrop-blur-xl border border-white/10 rounded-2xl shadow-[0_0_40px_-10px_rgba(0,0,0,0.5)] p-8 relative overflow-hidden group hover:border-cyan-500/30 transition-colors duration-500">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="space-y-2">
                                <label className="text-xs font-bold text-cyan-500 uppercase tracking-wider ml-1">Email Access-ID</label>
                                <div className="relative group/input">
                                    ...
                                    <input
                                        type="email"
                                        required
                                        className="block w-full pl-10 pr-3 py-3 bg-slate-950/50 border border-slate-700 rounded-lg text-slate-100 placeholder-slate-600 focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all"
                                        placeholder="admin@seatrace.com"
                                        value={email}
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative group/input">
                                    ...
                                    <input
                                        ...
                                        required
                                        className="block w-full pl-10 pr-10 py-3 bg-slate-950/50 border border-slate-700 rounded-lg text-slate-100 placeholder-slate-600 focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all"
                                        placeholder="••••••••"
                                        value={password}
                        ...
                        <div className="mt-6 pt-6 border-t border-white/5 text-center">
                            <p className="text-slate-500 text-sm">
                                ...
                                <button
                                    ...
                                    className="text-cyan-400 hover:text-cyan-300 font-semibold hover:underline transition-all"
                                >
                                    Request Clearance
                                </button>
                            </p>
